		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format"
			...
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="all"
					...
					<fo:region-after display-align="after" min-height="0.099cm"
			...
			<fo:page-sequence master-reference="all">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						<xsl:apply-templates select="convention" />
					</fo:block>
			...
			<fo:table table-layout="fixed" width="100%">
				...
				<fo:table-body>
					<fo:table-row >
						<fo:table-cell >
							<fo:block>
								<fo:external-graphic src="url('logo_UR1_UEB.jpg')" width="3cm" height="1cm"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell >
							<fo:block>
								<xsl:choose>
									<xsl:when test="university-center/logo">
											<fo:external-graphic height="1cm"><xsl:attribute name="src" >
												<xsl:value-of select="university-center/logo-path"/></xsl:attribute>
											</fo:external-graphic>
									</xsl:when>
									<xsl:otherwise>
				...
				<fo:table-body>
					<fo:table-row >
						...
						<fo:block line-height="110%" padding-top="5pt"
							...
							<xsl:value-of select="convention-type" />
							</fo:inline>
						</fo:block>
						<fo:block line-height="110%"  
						...
						<fo:block line-height="110%" padding-top="5pt"
							...
							<fo:inline font-size="8pt" font-style="italic"
								...
								<fo:inline text-decoration="underline">stages en administrations et établissement publics de l'Etat ne présentant pas une caractère industriel et commercial </fo:inline>
								es signataires de la présente convention de stage reconnaissent avoir pris connaissance du décret 2009-885 du 21 juillet 2009 relatif aux modalités d'accueil des étudiants de l'enseignement supérieur en stage dans les administrations et établissements publics de l'Etat 
				...
				<fo:table-body>
						...
						<!-- partie Etablissement Superieur - Stage -->
							<fo:table-cell number-columns-spanned="3" padding-top="5pt" padding-bottom="5pt" padding-left="5pt" padding-right="5pt">
								...
								Adresse : 
									<fo:inline font-weight="bold">
										<xsl:choose>
											...
											<xsl:otherwise>
												2, RUE DU THABOR CS 46510 35065 Rennes 
											</xsl:otherwise>
										</xsl:choose>
									</fo:inline>
								</fo:block>
								...
								Composante /UFR/ <xsl:text> </xsl:text>
									<fo:inline font-weight="bold">
										<xsl:value-of select="university-center/name-center" />
									</fo:inline>
								</fo:block>
								<fo:block line-height="110%" 
								hyphenate="false" language="fr" country="FR" font-size="11.5pt"
								...
								Adresse : (si différente de celle de l'université) 
									<fo:inline font-weight="bold">
										<xsl:value-of select="university-center/main-address-center" /> 
										<xsl:text> </xsl:text> 
										<xsl:value-of select="university-center/postal-code-center" />
										<xsl:text> </xsl:text> 
										<xsl:value-of select="university-center/town-center" /> 
									</fo:inline>
								</fo:block>
							</fo:table-cell>
					</fo:table-row>
					<fo:table-row text-align="left">
						<fo:table-cell padding-left="5pt" padding-right="5pt">
							...
							Tél :
							<xsl:value-of select="university-center/tel-center" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							<fo:block line-height="110%" 
							...
							padding-right="0.141cm"  >
							fax : 
							<xsl:value-of select="university-center/fax-center" /> 
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding-left="5pt" padding-right="5pt">
							<fo:block line-height="110%" 
							...
							padding-right="0.141cm" >
							mél : 
							<xsl:value-of select="university-center/mail-center" />  
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row text-align="left">
						<fo:table-cell number-columns-spanned="3" padding-top="5pt" padding-bottom="5pt" padding-left="5pt" padding-right="5pt">
									...
									Nom : 
									<fo:inline font-weight="bold">
										<xsl:value-of select="structure/structure-name" /> 
									</fo:inline>
									</fo:block>
									<fo:block line-height="110%" 
									hyphenate="false" language="fr" country="FR" font-size="11.5pt"
									...
									Adresse : 
										<fo:inline font-weight="bold">  
										<xsl:value-of select="structure/main-address-structure" />
										<xsl:text> </xsl:text>
										<xsl:value-of select="structure/postal-code-structure" />  
										<xsl:text> </xsl:text>
										<xsl:value-of select="structure/town-structure" /> 
										<xsl:text> </xsl:text>
										<xsl:value-of select="structure/country-structure" />
										</fo:inline> 
									</fo:block>
					...
					<fo:table-row text-align="left">
						<fo:table-cell padding-left="5pt" padding-right="5pt">
							...
							padding-right="0.141cm" padding-top="0.035cm" padding-bottom="0.035cm" >
							Tél :
							<xsl:value-of select="structure/phone-structure" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							<fo:block line-height="110%" 
							...
							padding-right="0.141cm" padding-top="0.035cm" padding-bottom="0.035cm" >
							fax : 
							<xsl:value-of select="structure/fax-structure " /> 
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding-left="5pt" padding-right="5pt">
							<fo:block line-height="110%" 
							...
							padding-right="0.141cm" padding-top="0.035cm" padding-bottom="0.035cm" >
							mél : 
							<xsl:value-of select="structure/mail-structure " />  
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row text-align="left">
						<fo:table-cell number-columns-spanned="3" padding-left="5pt" padding-right="5pt">
									...
									<fo:inline font-weight="bold"> 
										<xsl:value-of select="signer/civility" />
										<xsl:text> </xsl:text> 
										<xsl:value-of select="signer/name" /> 
										<xsl:text> </xsl:text>
										<xsl:value-of select="signer/first-name" /> 
									</fo:inline> 
									</fo:block>
									<fo:block line-height="110%" 
									hyphenate="false" language="fr" country="FR" font-size="11.5pt"
									...
									Qualité du représentant : 
									<fo:inline font-weight="bold"> 
									 	<xsl:value-of select="signer/function" />
									</fo:inline> 
									</fo:block>
									<fo:block line-height="110%" 
									hyphenate="false" language="fr" country="FR" font-size="11.5pt"
									...
									Lieu du stage : (si différent de l'adresse de l'entreprise)  
										...
										<xsl:if test="service/main-address != structure/main-address-structure"> 
							 				<fo:inline font-weight="bold">
											<xsl:value-of select="service/main-address" /> 
											<xsl:text> </xsl:text>
											<xsl:value-of select="service/postal-code" />  
											<xsl:text> </xsl:text>
											<xsl:value-of select="service/town" /> 
											<xsl:text> </xsl:text>
											<xsl:value-of select="service/country" /> 
										</fo:inline>
							 			</xsl:if>
					...
					<fo:table-row text-align="left">
						...
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Sexe :  
							<xsl:text> </xsl:text>
							<fo:inline font-weight="bold"><xsl:value-of select="student/code-sexe" /></fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							<fo:block line-height="110%" 
							...
							né(e)le :  
							<xsl:text> </xsl:text>
							<fo:inline font-weight="bold"><xsl:value-of select="student/date-naisddmmyyyy" /></fo:inline> 
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row margin-top="20px" text-align="left">
						<fo:table-cell number-columns-spanned="3"  padding-left="5pt" padding-right="5pt">
							...
							Adresse : 
							<fo:inline font-weight="bold">
										<xsl:value-of select="main-address" />
											<xsl:text> </xsl:text>
					...
					<fo:table-row text-align="left">
						...
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Tél portable : 
							<fo:inline font-weight="bold">
								<xsl:value-of select="portable-phone" />
							</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							<xsl:text> </xsl:text>
							<fo:inline font-weight="bold">
								<xsl:value-of select="student/mail" />							
							</fo:inline> 
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row text-align="left">
						<fo:table-cell number-columns-spanned="2" padding-top="5pt" padding-bottom="5pt" padding-left="5pt" padding-right="5pt">
								<fo:block line-height="110%" 
									...
									DATES DE STAGE Du : 
									<fo:inline font-weight="bold">
										<xsl:value-of select="stage-start" />
									</fo:inline>
									<xsl:text> </xsl:text> Au <xsl:text> </xsl:text>
									<fo:inline font-weight="bold">
										<xsl:value-of select="stage-end" /> 
									</fo:inline>
									<xsl:if test="@interruption = 'true'"> 
								 		<xsl:text> </xsl:text>
								 		avec interruption du : 
								 		<fo:inline font-weight="bold">
											<xsl:value-of select="interruption-start " />
										</fo:inline>
										<xsl:text> </xsl:text> au <xsl:text> </xsl:text>
										<fo:inline font-weight="bold">
											<xsl:value-of select="interruption-end " /> 
										</fo:inline>
									 </xsl:if>
								</fo:block>
							</fo:table-cell>
								...
								<xsl:choose>
										<xsl:when test="duree-exceptionnelle">
											<xsl:if test="duree-exceptionnelle != ''"> 
		 										<fo:inline font-weight="bold">
													<xsl:value-of select="duree-exceptionnelle" /> <xsl:text> </xsl:text>  <xsl:value-of select="unite-duree-exceptionnelle" />
												</fo:inline>
											</xsl:if>
											<xsl:if test="duree-exceptionnelle = ''"> 
		 										<fo:inline font-weight="bold">
									...
									<xsl:text> </xsl:text> soit en jours : ...............
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				...
				<fo:table-body>
					...
					<fo:table-row text-align="left">
						...
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Nom :  
								<fo:inline font-weight="bold"> 
								<xsl:value-of select="teacher-guide/name" /> 
							 </fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Nom :  
								<fo:inline font-weight="bold"> 
								<xsl:value-of select="pro-guide/name" /> 
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row text-align="left">
						...
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							prénom :  
								<fo:inline font-weight="bold"> 
								<xsl:value-of select="teacher-guide/first-name" /> 
							 </fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Prénom :  
								<fo:inline font-weight="bold"> 
								<xsl:value-of select="pro-guide/first-name" /> 
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row text-align="left">
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Fonction :  
								<fo:inline font-weight="bold"> 
								<xsl:if test="teacher-guide/member-type = 'ENS'"> 
							 		enseignant
							 	</xsl:if>
							 	<xsl:if test="teacher-guide/member-type != 'ENS'"> 
							 		personnel
						...
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Fonction :  
								<fo:inline font-weight="bold"> 
									 <xsl:value-of select="pro-guide/function" />
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row text-align="left">
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Tél :  
								<fo:inline font-weight="bold"> 
									<xsl:value-of select="teacher-guide/phone" />
							 	</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Tél :  
								<fo:inline font-weight="bold">
								<xsl:value-of select="pro-guide/phone" /> 
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row text-align="left">
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Mél :  
								<fo:inline font-weight="bold"> 
									<xsl:value-of select="teacher-guide/mail" />
							 	</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding-left="5pt" padding-right="5pt">
							...
							Mél :  
								<fo:inline font-weight="bold">
								<xsl:value-of select="pro-guide/mail" /> 
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row >
						<fo:table-cell padding-right="10pt">
							...
							<fo:block line-height="110%" padding-top="1pt" padding-bottom="1pt"
								...
								l'entreprise sera de <fo:inline font-weight="bold">
									<xsl:value-of select="nb-hours-hebdo" /> 
								</fo:inline> heures. Le stage est à 
								<fo:inline font-weight="bold">
									<xsl:value-of select="duration-work" />
								</fo:inline>
								 (préciser :  
								 <fo:inline font-weight="bold">
									<xsl:value-of select="duration-work-comment" /> )
								</fo:inline>
							...
							<fo:block line-height="110%" padding-top="2pt" padding-bottom="2pt"
								...
								ci-dessous les cas particuliers :<fo:inline font-weight="bold">
									<xsl:value-of select="work-night-ferie" /> 
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" 
								hyphenate="false" language="fr" country="FR" font-size="10pt"
						...
						<fo:table-cell >
							...
							<fo:block line-height="110%"  hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								...
								<xsl:variable name="nb-bonus-amount" select="bonus-amount" />
								<xsl:choose>
									<xsl:when test='$nb-bonus-amount=""'>
 
       							    </xsl:when>
									<xsl:otherwise>
										<fo:inline font-weight="bold">
												<xsl:value-of select="bonus-amount" /> 
											</fo:inline> euros <xsl:text> </xsl:text> <xsl:value-of select="unite-gratification" /> par mois
									</xsl:otherwise>
								</xsl:choose>
							</fo:block>
							<fo:block line-height="110%"  
							...
							<fo:block line-height="110%"  hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								...
								<fo:inline font-weight="bold">
									<xsl:value-of select="mode-vers-gratification" /> 
								</fo:inline>
							</fo:block>					
							...
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								...
								Liste des avantages offerts : <fo:inline font-weight="bold">
									<xsl:value-of select="advantages-nature" /> 
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
										hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif" text-align="justify"
					...
					<fo:table-row >
						<fo:table-cell padding-right="10pt">
							...
							<fo:block line-height="110%" hyphenate="false" language="fr" padding-top="2pt" padding-bottom="2pt"
									...
									responsabilité de l'établissement. Ce dernier devrait impérativement 
						...
						<fo:table-cell >
							...
							<fo:block line-height="110%"  hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								...
								<fo:inline font-weight="bold">
									<xsl:value-of select="nature-work" /> 
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%"  
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
							...
							<fo:block line-height="110%"  hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								...
								<fo:inline font-weight="bold">
									<xsl:value-of select="mode-validation-stage" /> 
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%"  hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif"
								padding-top="2pt">
