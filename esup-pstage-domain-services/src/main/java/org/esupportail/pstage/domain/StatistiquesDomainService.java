...
public interface StatistiquesDomainService extends Serializable {
    ...
    public List<StatisticItemDTO> getNumberOfConventionsByNbWeeks(Integer idCenter, String year, String etab)throws StatistiquesException;
    ...
    public List<StatisticItemDTO> getNumberOfConventionsByStudyAndNbWeeks(Integer idCenter, String year, String etab)throws StatistiquesException;
    ...
    public List<StatisticItemDTO> getNumberOfConventionsByDepartmentAndNbWeeks(Integer idCenter, String year, String etab)throws StatistiquesException;
    ...
    public List<StatisticItemDTO> getNumberOfConventionsByStepAndNbWeeks(Integer idCenter, String year, String etab)throws StatistiquesException;
