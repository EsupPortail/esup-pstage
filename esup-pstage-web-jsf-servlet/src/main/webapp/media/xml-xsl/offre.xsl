...
<xsl:stylesheet version="1.0"
				...
				<fo:table-body>
					<fo:table-row >
									...
									<xsl:when test="document('config.xml')/config/logoUniversiteOffre">
										<fo:external-graphic width="3cm"  height="1cm">
											<xsl:attribute name="src" >
												<xsl:value-of select="document('config.xml')/config/logoUniversiteOffre"/>
											</xsl:attribute>
										</fo:external-graphic>
									</xsl:when>
									<xsl:otherwise>
						...
						<fo:table-cell width="3cm">
							...
							<fo:block  width="3.493cm"
								line-height="110%" language="fr" country="FR" font-size="12pt">
								Tél : <xsl:value-of select="centre-gestion/telephone" />						
							</fo:block>
							<fo:block  width="3.493cm"
								line-height="110%" language="fr" country="FR" font-size="12pt">
								Courriel : <xsl:value-of select="centre-gestion/mail" />
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
	...
	<xsl:template name="infosOffre">
				...
				<fo:table-body padding-left="5pt">
					<fo:table-row >
						<fo:table-cell  background-color="#e6e6e6" text-align="left">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="14pt" font-family="Times New Roman,serif" font-weight="bold" text-decoration="underline">
								Titre de l'offre : 
							</fo:block>
						</fo:table-cell>
					...
					<fo:table-row >
						...
						<fo:table-cell text-align="left" padding-left="5pt">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
									hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">			
										<xsl:value-of select="concat(substring(./date-diffusion,9,2),'/',substring(./date-diffusion,6,2), '/',substring(./date-diffusion,1,4))"/> 
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row >
						...
						<fo:table-cell text-align="left" padding-left="5pt">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
									hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">			
										<xsl:value-of select="concat(substring(./date-fin-diffusion,9,2),'/',substring(./date-fin-diffusion,6,2), '/',substring(./date-fin-diffusion,1,4))"/> 
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row >
						<fo:table-cell  background-color="#e6e6e6" text-align="left">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Réf. de l'offre au sein de l'établissement d'accueil :					
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="left" padding-left="5pt">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
					...
					<fo:table-row >
						<fo:table-cell  background-color="#e6e6e6" text-align="left">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Adresse de l'établissement d'accueil
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="left" padding-left="5pt">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
					...
					<fo:table-row >
						<fo:table-cell  background-color="#e6e6e6" text-align="left">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Précision sur le début de la mission
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="left" padding-left="5pt">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
					...
					<fo:table-row >
						<fo:table-cell  background-color="#e6e6e6" text-align="left">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Commentaire(s) sur le temps de travail 
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="left" padding-left="5pt">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
					...
					<fo:table-row >
						<fo:table-cell  background-color="#e6e6e6" text-align="left">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Niveau de formation souhaité à partir de :
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="left" padding-left="5pt">
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
					...
					<fo:table-row >
						...
						<fo:table-cell text-align="left" padding-left="5pt">
							...
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								<xsl:if test="@cacher-nom-contact-cand = 'false'">
								Fonction : <xsl:value-of select="contact-cand/fonction" />
								</xsl:if>	
							</fo:block>
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								<xsl:if test="@cacher-tel-contact-cand = 'false'">
								Tél : <xsl:value-of select="contact-cand/tel" />
								</xsl:if>
							</fo:block>
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								 <xsl:if test="@cacher-mail-contact-cand = 'false'">
								 Mail :	<xsl:value-of select="contact-cand/mail" />
								</xsl:if>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row >
						...
						<fo:table-cell text-align="left" padding-left="5pt">
							...
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								<xsl:if test="@cacher-nom-contact-info = 'false'">
									Fonction : <xsl:value-of select="contact-info/fonction" />
								</xsl:if>
							</fo:block>
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								<xsl:if test="@cacher-tel-contact-info = 'false'">
								Tél : <xsl:value-of select="contact-info/tel" />
								</xsl:if>
							</fo:block>
							<fo:block line-height="110%"  padding-top="2pt" padding-bottom="2pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt" font-family="Times New Roman,serif">
								 <xsl:if test="@cacher-mail-contact-info = 'false'">
								 Mail :	<xsl:value-of select="contact-info/mail" />
								</xsl:if>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
		...
		<fo:block line-height="110%"  
			...
			offre imprimée le : <xsl:value-of select = "java:format (java:java.text.SimpleDateFormat.new('dd-MM-yyyy kk:mm:ss'), java:java.util.Date.new())"/> 
		</fo:block>
		<fo:block id="theEnd" />
	</xsl:template>
</xsl:stylesheet>