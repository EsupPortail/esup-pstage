				...
				<fo:table-row>
					<fo:table-cell padding-left="0.141cm" padding-right="0.141cm"
						...
						<fo:block line-height="130%" hyphenate="false" language="fr"
								  country="FR" font-size="9pt" font-family="Times New Roman,serif">
						  <fo:inline>
							Service de médecine préventive de l'établissement d'enseignement (le cas échéant) :	
						  </fo:inline> 							
						  <xsl:choose>
						...
						<fo:block line-height="130%" hyphenate="false" language="fr"
								  country="FR" font-size="9pt" font-family="Times New Roman,serif">
						  <fo:inline>
							Contact en cas de conflit (médiateur, conciliateur, etc.) : 
						  </fo:inline> 							
						  <xsl:choose>
					...
					<fo:table-row>
						<fo:table-cell padding-right="10pt">
							...
							<fo:block line-height="110%" padding-top="1pt"
									  padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									  font-size="10pt" font-family="Times New Roman,serif" text-align="justify">
								A l'étranger, les règles de gratification ou de rémunération relèveront du 
								droit local.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr" country="FR"
									  font-size="10pt" font-family="Times New Roman,serif" text-align="justify">
								Lorsque le stage a lieu en France et que la durée du stage est supérieure 
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								de la sécurité sociale n'est pas soumise à cotisation sociale. 
								Au-delà, les cotisations sociales sont calculées sur le différentiel 
							...
							<fo:block line-height="110%" padding-top="2pt"
									  ...
									  font-weight="bold">
								Article 5 bis - France - Accès aux
								droits des salariés -
								Avantages
							</fo:block>
							<fo:block line-height="110%" padding-top="2pt"
									  ...
									  font-family="Times New Roman,serif" text-align="justify">
								(Organisme de
								droit privé en France sauf règles
								particulières
							...
							<fo:block line-height="110%" padding-top="2pt"
									  ...
									  font-family="Times New Roman,serif" text-align="justify"
									  font-weight="bold">
								Article 5ter - France - Accès aux droits
								des agents -
								Avantages
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
							...
							<fo:block line-height="110%" padding-top="2pt"
								...
								charge dans les
								conditions fixées par le décret	n°2010-676 du 21
								juin 2010.								
							</fo:block>
							<fo:block line-height="110%" padding-top="2pt"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  text-align="justify">
								Pendant la durée du stage, le stagiaire bénéficie d'une protection maladie 
								et accident dès lors qu'il est affilié à un régime de sécurité sociale et 
								que le droit français s'applique.  	  
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  text-align="justify">
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								d'activités dans le ou les lieux du stage, soit au cours du trajet entre 
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								6.3 - Protection
								maladie du/de la stagiaire à l'étranger :
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								<fo:inline text-decoration="underline">Protection
									Protection issue du régime
									de sécurité social français
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								Norvège, de l'Islande, du Liechtenstein, de la Suisse, ou
								encore de tout autre Etat (dans ce dernier cas, cette
								disposition n'est pas applicable pour un stage au Danemark,
								Norvège, Islande, Liechtenstein ou Suisse), le stagiaire doit
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								nationalité
								française, le stagiaire doit demander le formulaire
								SE401Q (104
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  ...
									  space-after="0cm" font-weight="normal" text-align="justify">
								- dans tous
								les autres cas, le stagiaire qui engage des frais de santé
								doit vérifier ses conditions de prise en charge. Des écarts
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								l'étranger, des droits issus du régime de sécurité social français.
							</fo:block>
							<fo:block line-height="110%" padding-top="2pt"
									  padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									  font-size="10pt" font-family="Times New Roman,serif"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								utilisation par un étudiant (qui dispose du permis adéquat pour le conduire).
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  space-before="0cm" space-after="0cm" font-weight="normal"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr" padding-top="5pt"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif">
								A l'étranger, les congés ne sont pas obligatoires.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  padding-top="2pt">
								Toute interruption temporaire ou définitive du stage, est signalée aux 
								signataires de la convention. Une modalité
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  padding-top="2pt" country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  text-align="justify">
								Les raisons invoquées seront examinées en
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  ...
									  text-align="justify">
								Le devoir de
								réserve et de confidentialité est de rigueur absolue et
								apprécié
								par l'organisme
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  text-align="justify">
								En France, dans le cas où les activités du stagiaire donnent 
								lieu à la création d'une &#339;uvre protégée par le droit d'auteur 
								ou la propriété industrielle (y compris un logiciel), un contrat doit 
								être signé entre le stagiaire (auteur) et l'organisme d'accueil.						
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  text-align="justify">
								Le contrat devra notamment préciser une mission inventive, l'étendue des droits cédés, 
								l'éventuelle exclusivité, la destination, les supports utilisés et la durée de la cession, 
								ainsi que, le cas échéant, le montant de la contrepartie financière due au stagiaire 
								au titre de la cession. Ces dispositions s'appliquent sauf en cas de règles particulières 
								relatives aux stages réalisés au sein d'une personne morale de droit public ou de droit 
								privé réalisant de la recherche qui sont soumis à l'article L611-7-1 du code de 
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								montant de la gratification perçue. 
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  text-align="justify" padding-top="2pt">
                            ...
                            <fo:block line-height="110%" hyphenate="false" language="fr"
									  country="FR" font-size="10pt" font-family="Times New Roman,serif"
									  text-align="justify">
								Conformément à la règlementation relative à la protection des données 
								personnelles, le stagiaire devra être informé du traitement réservé 
								aux données personnelles qu'il aura été amené à fournir à l'établissement 
								de formation et à l'organisme d'accueil.
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
