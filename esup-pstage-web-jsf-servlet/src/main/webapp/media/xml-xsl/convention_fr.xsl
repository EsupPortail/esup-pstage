				...
				<fo:table-row margin-top="20px" text-align="left">
					<fo:table-cell number-columns-spanned="3"
						...
						<fo:block line-height="110%" hyphenate="false" language="fr"
							...
							padding-left="0.141cm" padding-right="0.141cm" padding-top="0.035cm"
							padding-bottom="0.035cm">
							Intitulé de la formation ou cursus suivi
							dans
				...
				<fo:table-row text-align="left">
					<fo:table-cell number-columns-spanned="2"
						...
						<fo:block line-height="110%" hyphenate="false" language="fr"
							...
							padding-bottom="0.035cm">
							<fo:inline font-weight="bold">
								Encadrement du stagiaire assuré
								par :
							</fo:inline>
						</fo:block>
					</fo:table-cell>
						...
						<fo:table-cell padding-top="2pt" padding-bottom="2pt">
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								<fo:inline font-size="8pt"> Article L612-9 du code de
									l'éducation : " La durée du ou des stages effectués par un même
									stagiaire dans une même entreprise ne peut excéder six mois par
									année d'enseignement", sauf exceptions
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="8pt" font-family="Times New Roman,serif"
					...
					<fo:table-row>
						<fo:table-cell padding-right="10pt">
							...
							<fo:block line-height="110%" padding-top="1pt"
								...
								d'accueil
								(entreprise, organisme public, association...) avec
								l'établissement
								d'enseignement supérieur et le stagiaire.
							</fo:block>
							...
							<fo:block line-height="110%" padding-top="1pt"
								...
								qui mettent en oeuvre les acquis
								de sa formation en vue de
								l'obtention d'un diplôme ou d'une
								certification.
								Le stagiaire se voit confier une ou des missions
								conformes au
								projet pédagogique défini par son établissement
								d'enseignement
							...
							<fo:block line-height="110%" padding-top="1pt"
								padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
								font-size="10pt" font-family="Times New Roman,serif" text-align="justify">
								La durée hebdomadaire maximale de présence du (de la) stagiaire
								dans
							...
							<fo:block line-height="110%" padding-top="2pt"
								...
								font-size="10pt" font-family="Times New Roman,serif" text-align="justify">
								Si le (la)
								stagiaire doit être présent(e) dans l'organisme
								d'accueil la nuit, le
								dimanche ou un jour férié, l'organisme doit
								indiquer
								ci-dessous
							...
							<fo:block line-height="110%" padding-top="1pt"
								...
								d'accueil,
								conserve son statut antérieur; il (elle) est suivi(e)
								régulièrement
								par l'établissement. L'organisme d'accueil nomme un
								...
								réalisation du
								stage. L'étudiant(e) pourra revenir à
								l'établissement
								pendant la durée du stage, pour y suivre certains
								cours
								demandés explicitement par le programme, participer à des
								réunions, les dates étant portées à la connaissance de
								l'organisme d'accueil par l'établissement et être autorisé, le
								cas échéant,
								à se déplacer.
							</fo:block>
							<fo:block line-height="110%" padding-top="2pt"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								5 : Gratification - Avantages en nature Remboursement de frais
							</fo:block>
							<fo:block line-height="110%" padding-top="1pt"
								padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
								font-size="10pt" font-family="Times New Roman,serif" text-align="justify">
							...
							<fo:block line-height="110%" padding-top="1pt"
								...
								professionnel,
								à défaut à 12,5 % du plafond horaire de la
								sécurité sociale
								défini en application
							...
							<fo:block line-height="110%" padding-top="1pt"
								...
								Il est entendu que pour les
								stages en administration
								ou établissement
								public administratif de
								l'Etat, la gratification est obligatoirement
								égale au plafond
								ci-dessus.
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block line-height="110%" padding-top="1pt"
								...
								l'étudiant(e)
								peut percevoir une gratification, en entreprise
								privée ou publique,
							...
							<fo:block line-height="110%" hyphenate="false" language="fr" country="FR"
								...
								formation éventuellement nécessités par le
								stage, seront
								intégralement
								pris en charge par celui-ci selon les modalités en
								vigueur dans
								l'organisme.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif"
								text-align="justify">
								Les stagiaires accèdent aux activités sociales et
								culturelles mentionnées à l'article L2323-83 du code du travail
							...
							<fo:block line-height="110%" padding-top="2pt"
								...
								font-style="italic" font-size="10pt" font-family="Times New Roman,serif"
								text-align="justify" font-weight="bold">
								Lorsqu'il se déroule en
								administration ou
								établissement public administratif de l'Etat,
								l'étudiant(e) verra ses frais de missions pris en charge
								conformément au
								décret 2006-781,
								avec comme résidence
								administrative le lieu de stage.
							</fo:block>
							<fo:block line-height="110%" padding-top="2pt"
								padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
								font-style="italic" font-size="10pt" font-family="Times New Roman,serif"
								...
								prise en charge des trajets domicile - lieu de stage, selon les
								conditions du décret 2010-676 : ...................(indiquer oui
								ou non)
							</fo:block>
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								au produit de 12,5% du plafond horaire de la sécurité sociale
							...
							<fo:block line-height="110%" hyphenate="false" language="fr" country="FR"
								...
								lieux rendus utiles pour les
								besoins de son stage
								<fo:inline font-size="10pt" font-style="italic">
									et pour les
									étudiant(e)s en médecine, en chirurgie dentaire ou en
									pharmacie
									qui n'ont pas un statut hospitalier,
									du stage hospitalier
									effectué dans les conditions prévues au b du
									2o de l'article L.
									412-8,
								</fo:inline>
								<fo:inline font-size="10pt" font-weight="bold">
									l'organisme
									d'accueil envoie la déclaration à la
								</fo:inline>
								Caisse Primaire d'Assurance Maladie (voir adresse en première
								page) en mentionnant l'établissement comme employeur,
								<fo:inline font-size="10pt" font-weight="bold">
									avec copie à
									l'établissement.
								</fo:inline>
					...
					<fo:table-row>
						<fo:table-cell padding-right="10pt">
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								bénéficie de la couverture légale en application
								des dispositions
								des articles L 411-1
								et suivants du code de la Sécurité Sociale.
								En cas d'accident
								survenant à l'étudiant(e), soit au cours des
								travaux dans l'organisme, soit au cours du trajet, soit sur des
								lieux rendus utiles
								pour les besoins de son stage, l'organisme
								d'accueil effectue toutes
								les démarches nécessaires
								auprès de la
								Caisse Primaire d'Assurance Maladie et informe
								l'établissement
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif"
								text-align="justify">
								<fo:inline font-size="10pt" font-weight="bold">6.3 Protection
									Maladie du stagiaire à l'étranger :
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
								font-family="Times New Roman,serif" text-align="justify">
								1) Protection
								issue du régime étudiant(e) français :
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
								font-family="Times New Roman,serif" space-before="0cm"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								de l'Union Européenne, l'étudiant doit demander la Carte
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								nationalité française, l'étudiant doit demander le formulaire
								<fo:inline font-size="10pt" text-decoration="underline">SE401Q
								</fo:inline>
								(104
								pour les stages en entreprise, 106 pour les stages en
								université).
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
							...
							<fo:block line-height="110%" padding-top="2pt"
								...
								text-align="justify">
								<fo:inline font-size="10pt" text-decoration="underline">- Dans
									tous les autres cas de figure :
								</fo:inline>
								<!-- Les étudiant(e)s qui engagent des frais de santé à l'étranger 
									peuvent être remboursé(e)s auprès de la mutuelle qui leur tient lieu de Caisse 
									...
									des écarts importants peuvent exister. -->
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif"
								text-align="justify">
								Les étudiant(e)s qui engagent des frais de santé à
								l'étranger
								peuvent être remboursé(e)s auprès de la mutuelle qui
								leur tient
								lieu
								de Caisse de Sécurité Sociale étudiante, au
								retour, et sur
								présentation des justificatifs : le remboursement
								s'effectue
								alors sur
								la base des tarifs de soins français, des
								écarts importants
								peuvent exister.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
							...
							<fo:block line-height="110%" padding-top="2pt"
								...
								space-before="0cm" space-after="0cm" font-weight="normal"
								text-align="justify">
								° Il est donc fortement recommandé à l'étudiant(e) de
								souscrire une
								assurance Maladie complémentaire spécifique,
								valable pour le pays
								et la
								durée du stage, auprès de l'organisme
								de son choix (mutuelle
								étudiante, mutuelle des parents, compagnie
								privée ad hoc...).
							</fo:block>
							...
							<fo:block line-height="110%" padding-top="2pt"
								...
								: si l'organisme d'accueil fournit à l'étudiant(e) une
								couverture
								Maladie en vertu des dispositions du droit local (voir
								2 ci-dessous),
								alors l'étudiant(e) peut choisir de bénéficier de
								cette
								protection
								Maladie locale. Avant d'effectuer un tel choix,
								il vérifiera l'étendue
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
								font-family="Times New Roman,serif" text-align="justify">
								<fo:inline font-size="10pt">2) Protection
									issue de l'organisme
									d'accueil :
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
								font-family="Times New Roman,serif" text-align="justify">
								<fo:inline font-size="10pt">En cochant la
									case appropriée,
									l'Organisme d'accueil indique ci-après s'il
									fournit une
									protection Maladie au stagiaire, en vertu du droit
									local :
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
							...
							<fo:block>
								...
								<fo:inline font-size="10pt" font-weight="bold">OUI
								</fo:inline>
								(celle-ci s'ajoute au maintien, à l'étranger, des droits issus
								du régime français étudiant)
							</fo:block>
							<fo:block>
								<fo:external-graphic src="url('square.JPG')" />
								<fo:inline font-size="10pt" font-weight="bold">NON
								</fo:inline>
						...
						<fo:table-cell>
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								s'engage
								à
								cotiser pour la protection du stagiaire et à faire les
								déclarations
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								font-family="Times New Roman,serif" text-align="justify">
								2) La déclaration
								des accidents de travail incombe à
								l'établissement qui doit être
								informé par l'organisme d'accueil
								par écrit dans un délai de 48
								heures.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								font-family="Times New Roman,serif" text-align="justify">
								4) Pour le cas où
								l'une seule des conditions prévues au point
								6.4 1/ n'est pas
								remplie, l'organisme d'accueil s'engage par la
								présente
								convention à couvrir le stagiaire contre le risque
								d'accident de
								travail, de trajet et les maladies
								professionnelles et à en
								assurer toutes les déclarations
								nécessaires.
							</fo:block>
							...
							<fo:block line-height="110%" hyphenate="false" language="fr" 
								...
								impérativement signaler
								<fo:inline font-size="10pt" text-decoration="underline">immédiatement
								</fo:inline>
								cet accident à
								l'établissement.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr" 
								...
								stage,
								l'organisme d'accueil doit prendre toutes les dispositions
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								font-family="Times New Roman,serif" text-align="justify">
								L'organisme
								d'accueil et l'étudiant(e) déclarent être garantis
								au
								titre de la
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif"
								text-align="justify">
								Quelle que soit la nature du stage et le pays de
								destination, le (la)
								stagiaire s'engage à se couvrir par un
								contrat d'assistance (rapatriement
								sanitaire, assistance
								juridique etc.) et par un contrat
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								disposition du (de la) stagiaire,
								il lui incombe de vérifier
								préalablement que la police d'assurance
								du véhicule couvre son
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								<fo:inline font-size="10pt">
									Lorsque dans le cadre de son
									stage, l'étudiant(e) utilise son propre
									véhicule ou un véhicule,
									prêté par un tiers, il (elle) déclare
									expressément
									à l'assureur
									dudit véhicule cette utilisation qu'il (elle) est
									amené à faire
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								Durant
								son stage,
								l'étudiant(e) est soumis à la discipline et au
								règlement
								intérieur (qui doit être porté à la connaissance de
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								par
								l'établissement. Dans ce cas, l'organisme d'accueil informe
								l'établissement
								des manquements et lui fournit éventuellement les
								éléments
								constitutifs.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								fin au stage de
								l'étudiant(e) tout en respectant les dispositions
								fixées à
								l'article 9
					...
					<fo:table-row>
						<fo:table-cell padding-right="10pt">
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								font-family="Times New Roman,serif" text-align="justify">
								Toute difficulté
								survenue dans le déroulement du stage devra être portée
								à la
								connaissance de tous les intéressés afin d'être résolue au
								plus
								vite.
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								stagiaire pourra bénéficier de congés
								sous réserve d'accord de
								l'organisme d'accueil et que la durée du
								stage
								soit respectée.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Pour toute autre
								interruption temporaire du stage (maladie, maternité,
								absence
								injustifiée...) l'organisme d'accueil avertira le responsable
								de
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								font-family="Times New Roman,serif" text-align="justify">
								Le devoir de
								réserve est de rigueur absolue. Les étudiant(e)s
								stagiaires
								prennent donc l'engagement de n'utiliser en aucun cas
								les
								...
								stage. Cet
								engagement vaudra non seulement pour la durée du stage
								mais
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								text-align="justify">
								<fo:inline font-size="10pt">
									Nota : Dans le cadre de la
									confidentialité des informations
									contenues dans
									le rapport,
									l'organisme d'accueil peut demander une restriction
									de la
									diffusion du
									rapport, voire le retrait de certains éléments très
									confidentiels.
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								text-align="justify">
								<fo:inline font-size="10pt">
									Les personnes amenées à en
									connaître sont contraintes par le
									secret
									professionnel à
									n'utiliser ni ne divulguer les informations du rapport.
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								font-family="Times New Roman,serif" text-align="justify">
								S'il advenait
								qu'un contrat de travail prenant effet avant la date
								de fin
								du
								stage soit signé avec l'organisme d'accueil la présente
								convention
								deviendrait caduque ; l' « étudiant(e) » ne relèverait
								plus de la
								responsabilité de l'établissement d'enseignement. Ce
								dernier
								devrait impérativement
								en être averti avant la signature
								du contrat.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								padding-top="2pt" padding-bottom="2pt" country="FR" font-size="10pt"
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								font-family="Times New Roman,serif" text-align="justify">
								A l'issue du
								stage, l'organisme d'accueil délivre au stagiaire
								une
								attestation
								de stage et remplit une fiche d'évaluation de l'activité du
								stagiaire (annexe) qu'il retourne à l'établissement
								d'enseignement
								supérieur.
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								travail à fournir éventuellement en joignant une annexe)
								<fo:inline font-weight="bold">
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Evaluation de la
								qualité du stage : A l'issue du stage, les trois parties
								intéressées sont invitées à formuler une appréciation sur la
								qualité
								du stage.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Le tuteur organisme
								d'accueil ou tout autre membre de l'organisme
								d'accueil appelé à
								se rendre à l'établissement dans le cadre de la
								préparation, du
								déroulement et de la validation du stage ne peut
								prétendre à une
								quelconque prise en charge ou indemnisation de
								la
								part de
								l'établissement.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif">
								Un avenant à la
								convention pourra éventuellement être établi en cas
								de
								prolongation de stage faite à la demande de l'organisme et de
								l'étudiant(e). En aucun cas la date de fin de stage ne pourra
								être
								postérieure au 30/09 de l'année en cours.
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
								country="FR" font-size="10pt" font-family="Times New Roman,serif">
								L'accueil successif de
								stagiaires, au titre de conventions de stage différentes,
								pour
								effectuer des stages dans un même poste n'est possible qu'à
								l'expiration d'un délai de carence
								égal au tiers de la durée du
								stage précédent. Cette disposition
								n'est pas applicable lorsque
								ce stage
								précédent a été interrompu avant son terme à
							...
							<fo:block line-height="110%" hyphenate="false" language="fr"
								...
								Tout litige non
								résolu par voie amiable sera soumis à la compétence
								de la
							...
							<fo:block line-height="110%" padding-top="2pt"
								padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
								font-size="10pt" font-family="Times New Roman,serif">
								<fo:inline text-decoration="underline">VISAS DES TUTEURS :
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" padding-top="2pt"
								padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block line-height="110%" padding-top="5pt"
								hyphenate="false" language="fr" country="FR" font-size="10pt"
								font-family="Times New Roman,serif" text-align="center">
								<fo:inline font-weight="bold">CHARTE DES STAGES ETUDIANTS EN
									ENTREPRISE
								</fo:inline>
							</fo:block>
							<fo:block line-height="110%" hyphenate="false" language="fr"
						...
						<fo:table-row>
							<fo:table-cell padding-right="10pt">
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									Le développement des stages est aujourd'hui
									fondamental en
									matière d'orientation et d'insertion
									professionnelle des jeunes.
									En
									effet, le stage permet la mise en
									oeuvre de connaissances
									théoriques dans un cadre professionnel
									et donne à l'étudiant
									une
									expérience du monde de l'entreprise et
									de ses métiers. Dans cette
									perspective, il est fondamental de
									rappeler que les stages ont
									une
									finalité pédagogique, ce qui
									signifie qu'il ne peut y avoir de stage
									hors parcours
									pédagogique. En aucun cas un stage ne peut être
									considéré comme
									un emploi. La présente charte, qui a été
									rédigée
									par les services
									de l'Etat, les représentants des entreprises, les
									représentants
									des établissements d'enseignement supérieur, et
									les
									représentants des étudiants, a dès lors pour objectif de
									sécuriser la
									pratique des stages, tout en favorisant leur
									développement
									bénéfique à la fois pour les jeunes et pour les
									entreprises.
								</fo:block>
								...
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">II - CHAMPS, DEFINITION
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">1 - Le champ de la charte
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									Le champ de la charte concerne tous les stages
									d'étudiants en
									entreprise, sans préjudice des règles
								...
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">2 - Le stage
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									La finalité du stage s'inscrit dans un projet
									pédagogique et n'a de
									sens que par rapport à ce projet. Dès lors
									le stage :
									- permet la
									mise en pratique des connaissances en
									milieu
									professionnel ;
									- facilite le passage du monde de
								...
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">III - ENCADREMENT DU STAGE
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">1 - La formalisation du projet
									de stage
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									Le projet de stage fait l'objet d'une concertation
									entre un
									enseignant de l'établissement, un membre de
									l'entreprise et
									l'étudiant. Ce projet de stage est formalisé
									dans la convention
									signée par l'établissement d'enseignement,
									l'entreprise et le
									stagiaire.
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">2 - La convention
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									La convention précise les engagements et les
									responsabilités de
									l'établissement d'enseignement, de
									l'entreprise et de l'étudiant. Les
									rubriques obligatoires sont
									mentionnées en annexe à la charte.
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">3 - Durée du stage
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									La durée du stage est précisée dès les premiers
									contacts entre
									l'établissement d'enseignement et l'entreprise.
									L'étudiant en est
									tenu informé. La durée du stage figure
								...
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">4 - Les responsables de
									l'encadrement
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									...
									travaillent en
									collaboration, sont informés et s'informent de
									l'état
									d'avancement
									du stage et des difficultés éventuelles. Le
									responsable du stage
									au
									sein de l'établissement d'enseignement
									est le garant de
									l'articulation entre les finalités du cursus de
									formation et
									celles du
									stage, selon les principes de la présente
									charte. Leurs institutions
									respectives reconnaissent la
									nécessité de leur investissement,
									notamment en temps, consacré à
									l'encadrement.
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">5 - Evaluation
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									évaluation qui résulte de la
									double appréciation des
									responsables de l'encadrement du stage.
									Chaque établissement
									d'enseignement décide de la valeur qu'il
									accorde aux stages
									prévus dans le cursus pédagogique.
								</fo:block>
							</fo:table-cell>
							<fo:table-cell>
								<fo:block line-height="110%" padding-top="1pt"
									...
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									Les modalités concrètes d'évaluation sont
									mentionnées dans la
									convention. L'évaluation est portée dans une
									"fiche
									d'évaluation"
									qui, avec la convention, constitue le
									"dossier de stage". Ce
									dossier de stage est conservé par
									l'établissement
									d'enseignement.
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									Les signataires de la convention sont invités à
									formuler une
								...
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">IV - ENGAGEMENT DES PARTIES
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">1 - L'étudiant vis-à-vis de
									l'entreprise
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									les
									délais prévus ; ce document devra être présenté aux
									responsables
									de l'entreprise avant d'être soutenu
									<fo:inline font-style="italic">
										(si le contenu le nécessite, le
										mémoire poura, à la demande de l'entreprise, rester
										confidentiel).
									</fo:inline>
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">2 - L'entreprise vis-à-vis de
									l'étudiant
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									- désigner un responsable de stage ou une équipe
									tutorale dont la
									tâche sera de :
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									* l'informer sur les règles, les codes et la culture
									de l'entreprise
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									* l'aider dans l'acquisition des compétences
									nécessaires
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									effectuées
									qui pourra accompagner les futurs
									<fo:inline font-style="italic">
										curriculum vitae
									</fo:inline>
									de l'étudiant.
								...
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">3 - L'établissement
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									son stage, en lui
									affectant un enseignant qui veillera au bon
									déroulement du stage ;
									mettre à la disposition de ce dernier les
									outils nécessaires à
									l'appréciation de la qualité du stage par
									l'étudiant ;
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									...
									guider et le
									conseiller dans la réalisation de son rapport de
									stage ou de son
									mémoire et organiser la soutenance en permettant
									à un
								...
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">4 - L'entreprise et
									l'établissement d'enseignement
								</fo:block>
								<fo:block line-height="110%" padding-top="1pt"
									padding-bottom="1pt" hyphenate="false" language="fr" country="FR"
									...
									supérieur veillent à
									échanger les informations nécessaires
									avant, pendant et après le
									stage. Ils respectent par ailleurs
									leurs règles respectives de
									confidentialité et de déontologie.
								</fo:block>
								<fo:block line-height="110%" padding-top="2pt"
									padding-bottom="2pt" hyphenate="false" language="fr" country="FR"
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify" font-weight="bold">5 - L'étudiant vis à vis des
								...
								<fo:block line-height="110%" padding-top="1pt"
									...
									font-size="10pt" font-family="Times New Roman,serif"
									text-align="justify">
									L'étudiant s'engage à fournir l'appréciation de la
									qualité de son
