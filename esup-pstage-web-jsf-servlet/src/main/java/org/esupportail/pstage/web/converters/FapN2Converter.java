 ...
 *
 */
public class FapN2Converter implements Serializable, Converter {
	...
	public String getAsString(
		...
		if (!(value instanceof FapN2DTO)) {
			throw new UnsupportedOperationException(
					"object " + value + " is not a FapN2DTO.");
		}
		FapN2DTO e = (FapN2DTO) value;
		return ""+e.getCode();
	}
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getFapN2FromCode(value);
	}
	/**
