 ...
 *
 */
public class TempsTravailConverter implements Serializable, Converter {
	...
	public String getAsString(
		...
		if (!(value instanceof TempsTravailDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getTempsTravailFromId(Utils.convertStringToInt(value));
	}
	/**
