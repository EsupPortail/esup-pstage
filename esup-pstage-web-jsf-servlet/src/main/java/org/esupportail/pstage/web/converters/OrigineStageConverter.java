 ...
 *
 */
public class OrigineStageConverter implements Serializable, Converter {
	...
	public String getAsString(
		...
		if (!(value instanceof OrigineStageDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getOrigineStageDTOFromId(Utils.convertStringToInt(value));
	}
	/**
