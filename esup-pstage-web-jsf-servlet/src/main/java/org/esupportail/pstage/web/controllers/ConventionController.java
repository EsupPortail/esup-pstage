...
public class ConventionController extends AbstractContextAwareController {
	 ...
	 */
	private Object selectedEtapeEtude;
	/**
	 * choixEtape.
	 */
	...
	/**
	 * Vrai si recherche avancï¿½e, faux si recherche simple.
	 */
	 ...
	 * @return A String
	 */
	public String goToChoixEtapeEtudiant() {
	 ...
	 * @return A String
	 */
	public String goToCreerConventionCtrlInfosEtu() {
		...
		if (selAssurance == null) {
			addErrorMessage("formConvention:include:affilss", "CONVENTION.CREERCONVENTION.AFFILSS.OBLIGATOIRE");
			ctrlInfosOK = false;
		}
		...
		if (selCaisseRegime == null) {
			if (selAssurance != null) {
				if (!selAssurance.getCodeCtrl().equals(DonneesStatic.ASS_CODE_CTRL_ETRANGER)) {
					addErrorMessage("formConvention:include:caisses", "CONVENTION.CREERCONVENTION.CAISSEREGIME.OBLIGATOIRE");
					ctrlInfosOK = false;
				}
		...
		if (isEtudiantSupUneEtape()) {
			if (selectedEtapeEtude == null) {
				addErrorMessage("formConvention:include:choixEtape", "CONVENTION.CREERCONVENTION.ETAPE.OBLIGATOIRE");
				ctrlInfosOK = false;
			}
		...
		if (isEtudiantSupUnElp()) {
			if (selectedElp == null) {
				addErrorMessage("formConvention:include:choixElp", "CONVENTION.CREERCONVENTION.ELP.OBLIGATOIRE");
				ctrlInfosOK = false;
			}
		...
		if (!StringUtils.hasText(etudiantRef.getPostalCode())) {
			if (StringUtils.hasText(etudiantRef.getCountry())) {
				if (etudiantRef.getCountry().equalsIgnoreCase(DonneesStatic.PAYS_FR)) {
					addErrorMessage("formConvention:include:codePostal", "CONVENTION.CREERCONVENTION.CODEPOSTAL.OBLIGATOIRE");
					ctrlInfosOK = false;
				}
			}
		}
	 ...
	 * @return A String
	 */
	public String goToCreerConventionEtape1ConfirmInfosEtu() {
		return "_creerConventionEtape1ConfirmInfosEtu";
	}
	
	/**
	 * @return A String
	 */
	public String goToCreerConventionEtape1DemandeLienOffre() {
		return "_creerConventionEtape1DemandeLienOffre";
	}
	...
	/**
	 * Etape 02 : Recherche ï¿½tablissement.
	 * @return a String
	 */
	...
	public String goToCreerConventionEtape1Offre() {
		...
		sequenceEtapeEnum = SequenceEtapeEnum.etape2;
		return "creerConventionEtape1Offre";
	}
	...
	public String rechercheNumOffre() {
		...
		if (!StringUtils.hasText(this.numOffreConvention)) {
			addErrorMessage("formConvention:include:idOffre", "CONVENTION.ETAPE1.RECHERCHENUMOFFRE.OBLIGATOIRE");
			ctrlOK = false;
		}
		try {
			numOffre = Integer.parseInt(this.numOffreConvention);
		} catch (NumberFormatException e) {
			addErrorMessage("formConvention:include:idOffre", "CONVENTION.ETAPE1.RECHERCHENUMOFFRE.NUMERIQUE");
			ctrlOK = false;
		}
		if (ctrlOK) {
			...
			if (offre != null) {
				...
				if (offre.getIdStructure() > 0) {
					...
					if (structureTmp != null) {
						...
						retour = "creerConventionEtape2DetailsEtab";
					}
				}
				
			} else {
				addErrorMessage("formConvention:include:idOffre", "CONVENTION.ETAPE1.RECHERCHENUMOFFRE.AUCUNE");
			}
		}
		return retour;
	}
	 ...
	 * @return String
	 */
	public String goToCreerConventionModifEtab() {
		String ret = null;
	...
	public String modifierEtablissement() {
		...
		while (ifm.hasNext()) {
			...
			fc.addMessage("formConvention:include:formModifEtab",
		...
		while (ifm.hasNext()) {
			FacesMessage fm = ifm.next();
			fc.addMessage("formConvention:include:formAffEtab",
	 ...
	 * @return A String
	 */
	public String goToCreerConventionCtrlStage() { 
		boolean ctrlInfosOK = true;
		String retour = null;
		// ctrl donnees stage
		String nomForm = "formConvention:include";
	 ...
	 * @return A String
	 */
	public String goToCreerConventionlisteEtu() {
	 ...
	 * @return A String
	 */
	public String goToCreerConventionlisteEtuR() {
		return "creerConventionEtape1ListeEtudiant";
	}
	/**
	 * @return A String
	 */
	 ...
	 * @return A String
	 */
	public String goToCreerConventionEtape5StageR() {
		this.ctrlInfosStageOK = false;
	...
	public String goToCreerConventionEtape6RespPedago() {
		...
		return "_creerConventionEtape6RechEnseignant";
	}
	/**
	 * @return A String
	 */
	public String goToCreerConventionEtape6Enseignant() {
		sequenceEtapeEnum = SequenceEtapeEnum.etape6;
	 ...
	 * @return A String
	 */
	public String goToCreerConventionEtape6listeEnseignant() {
		return "creerConventionEtape6ListeEnseignant";
	}
	/**
	 * @return A String
	 */
	...
	public String goToAjouterConvention() {
		...
		try {
			if (this.convention.getEnseignant() != null) {
				if (this.convention.getEnseignant().getUidEnseignant() != null) {
		...
		//	SelectItem selecAnneeUniv = (SelectItem) selAnneeUniversitaire;
		...
		try {
			...
			if (idConvention > 0) {
				...
				retour = "creerConventionEtape8DetailsRecap";
				addInfoMessage(null, "CONVENTION.CREERCONVENTION.CONFIRMATION");
	 ...
	 * @return A String
	 */
	public String rechercheInfosEtudiant(final String idEtudiant) {
		this.ctrlInfosEtuOK = false;
		this.ctrlInfosStageOK = false;
		String retour = null;
		...
		if (resultatEtudiantRef != null) {
			if (!resultatEtudiantRef.getAdministrationApogee().isStatusApogee()) {
				if (logger.isDebugEnabled()) {
					...
					addErrorMessage("formConvention:include:identEtudiant", "RECHERCHEETU.PAS.IA");
		...
		if (resultatEtudiantRef == null) {
			addErrorMessage("formConvention:include:identEtudiant", "RECHERCHEETU.INVALIDE");
		}
		retour = recupInfosEtudiantRef();
		return retour;
	}
	/**
	 * @return String
	 */
	public String recupInfosEtudiantRef() {
		String retour = null;
	...
	public String rechercheEtudiant() {
		...
		if ((!StringUtils.hasText(this.rechIdentEtudiant)) && (! StringUtils.hasText(this.rechNomEtudiant)) && (! StringUtils.hasText(this.rechPrenomEtudiant))) {
			addErrorMessage("formConvention:include:oblig", "RECHERCHEETU.OBLIGATOIRE.RESPECTER");
			numEtuNomPrenomOK = false;
		}
		if (StringUtils.hasText(this.rechIdentEtudiant) && StringUtils.hasText(this.rechNomEtudiant)) {
			addErrorMessage("formConvention:include:nom", "RECHERCHEETU.OPTION");
			numEtuNomPrenomOK = false;
		}
		...
		if (!StringUtils.hasText(this.rechNomEtudiant) && StringUtils.hasText(this.rechPrenomEtudiant)) {
			addErrorMessage("formConvention:include:nom", "RECHERCHEETU.OPTION.PRENOM");
			numEtuNomPrenomOK = false;
		}
		if (StringUtils.hasText(this.rechPrenomEtudiant)) {
			if (this.rechPrenomEtudiant.length() < 3 ) {
				addErrorMessage("formConvention:include:prenom", "RECHERCHEETU.PRENOM2");
				numEtuNomPrenomOK = false;
			}
		}
		if (numEtuNomPrenomOK) {
			...
			if (StringUtils.hasText(this.rechIdentEtudiant)) {
				...
				if (resultatEtudiantRef == null || resultatEtudiantRef.getId() == null) {
					addErrorMessage("formConvention:include:identEtudiant", "RECHERCHEETU.INVALIDE");
				}
			} else {
				...
				if (StringUtils.hasText(this.rechNomEtudiant) || StringUtils.hasText(this.rechPrenomEtudiant) ) {
					...
					if (this.listeResultatsRechercheEtudiant.isEmpty()) {
						addErrorMessage("formConvention:include:nom", "RECHERCHEETU.INVALIDE");
					}
					if (this.listeResultatsRechercheEtudiant.size() == 1) {
						...
						if (etudiantRefTmp.getAdministrationApogee() != null ){
							if (!etudiantRefTmp.getAdministrationApogee().isStatusApogee()) {
								...
								addErrorMessage("formConvention:include:nom", etudiantRefTmp.getAdministrationApogee().getRaison());
								resultatEtudiantRef = null;
								listeResultatsRechercheEtudiant = null;
							}
						} else {
			...
			if (this.listeResultatsRechercheEtudiant != null) {
				retour = goToCreerConventionlisteEtu();
			}
		}
		return retour;
	}
	...
	public String rechercheEnseignantCrea() {
		...
		if (this.resultatEnseignant != null) {
			retour = goToCreerConventionEtape6Enseignant();
		}
		if (this.listeResultatsRechercheEnseignant != null) {
			retour = goToCreerConventionEtape6listeEnseignant();
		}
		return retour;
	}
	/**
	...
	public void rechercheEnseignantAvenant() {
		...
		this.listeResultatsRechercheEnseignant = new ArrayList<Enseignant>();
		rechercheEnseignant(nomForm);
	}
	/**
	 * @return A String
	...
	public String goToEnseignantValid() {
		...
		try {
			...
			if (enseignantExist == null) {
                ...
                // pour traiter le cas que l'enseignant n'a pas l'affectation
                if (this.convention.getEnseignant().getAffectation() != null)
                ...
                // on ne crÃ©e pas l'affectation null ou l'affectation avec le code null
	...
	/**
	 * recharge Ufr ï¿½ partir de la selection etape etude.
	 * @param e 
	 */
	public void rechargeUfr(final ActionEvent e) {
		if (selectedEtapeEtude != null) {
			SelectItem selEtapeEtude = (SelectItem) selectedEtapeEtude;
			EtapeInscription ufrEtape = rechUfrEtape(selEtapeEtude.getValue().toString());
			if (ufrEtape != null) {
			...
			this.listeELPEtapes = rechElpEtape(selEtapeEtude.getValue().toString());
			if (this.listeELPEtapes != null) {
				if (this.listeELPEtapes.size() == 1) {
					this.etudiantRef.setTheCodeElp(this.listeELPEtapes.get(0).getCodElp());
					this.etudiantRef.setTheLibElp(this.listeELPEtapes.get(0).getLibElp());
	 ...
	 * @param e
	 */
	public void rechargeElp(final ActionEvent e) {
		if (selectedElp != null) {
			ElementPedagogique selElp = (ElementPedagogique) selectedElp;
			if (this.etudiantRef.getListeELPs() != null ) {
				if (!this.etudiantRef.getListeELPs().isEmpty()) {
					List<ElementPedagogique> listeELPs = new ArrayList<ElementPedagogique>();
					listeELPs = this.etudiantRef.getListeELPs();
					...
					for (Iterator<ElementPedagogique> itelp = listeELPs.iterator(); itelp.hasNext();) {
						ElementPedagogique elpedago = itelp.next();
						if (elpedago.getCodElp().equals(selElp.getCodElp())) {
	...
	/**
	 * Contrï¿½le la liste des rï¿½sultats.
	 * Si un seul rï¿½sultat, transfert du rï¿½sultat vers "this.resultatRechercheEtudiant" 
	 * pour un affichage du dï¿½tail etudiant
	 */
	...
	/**
	 * Contrï¿½le la liste des rï¿½sultats.
	 * Si un seul rï¿½sultat, transfert du rï¿½sultat vers "this.resultatEnseigant" 
	 * pour un affichage du dï¿½tail enseigant
	 */
	...
	/**
	 * Mini recherche du numï¿½ro d'offre.
	 * @param suggest
	 * @return List<OffreDTO>
	 */
	public List<OffreDTO> suggestOffre(Object suggest) {
        String intitule = (String) suggest;
	...
	/**
	 * Passage du moteur simple ï¿½ avancï¿½ et vice-versa.
	 */
	...
	/**
	 * @return the selectedEtapeEtude
	 */
	public Object getSelectedEtapeEtude() {
		return selectedEtapeEtude;
	}
	/**
	 * @param selectedEtapeEtude the selectedEtapeEtude to set
	 */
	public void setSelectedEtapeEtude(final Object selectedEtapeEtude) {
		this.selectedEtapeEtude = selectedEtapeEtude;
	}
	/**
	...
	/**
	 * @return the selectedElp
	 */
	public Object getSelectedElp() {
		return selectedElp;
	}
	/**
	 * @param selectedElp the selectedElp to set
	 */
	public void setSelectedElp(final Object selectedElp) {
		this.selectedElp = selectedElp;
	}
	/**
