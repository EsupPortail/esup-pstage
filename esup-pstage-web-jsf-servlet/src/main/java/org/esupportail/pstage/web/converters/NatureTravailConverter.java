 ...
 *
 */
public class NatureTravailConverter implements Serializable, Converter {
	...
	public String getAsString(
		...
		if (!(value instanceof NatureTravailDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getNatureTravailDTOFromId(Utils.convertStringToInt(value));
	}
	/**
