 ...
 *
 */
public class TypeConventionConverter implements Serializable, Converter {
	 ...
	 * Bean constructor.
	 */
	public TypeConventionConverter() {
		super();
	}
	/**
	...
	public String getAsString(
		...
		if (!(value instanceof TypeConventionDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getTypeConventionDTOFromId(Utils.convertStringToInt(value));
	}
	/**
