 ...
 *
 */
public class ModeValidationStageConverter implements Serializable, Converter {
	 ...
	 * Bean constructor.
	 */
	public ModeValidationStageConverter() {
		super();
	}
	/**
	...
	public String getAsString(
		...
		if (!(value instanceof ModeValidationStageDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getModeValidationStageDTOFromId(Utils.convertStringToInt(value));
	}
	/**
