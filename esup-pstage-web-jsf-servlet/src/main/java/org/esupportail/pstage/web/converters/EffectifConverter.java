 ...
 *
 */
public class EffectifConverter implements Serializable, Converter {
	...
	public String getAsString(
		...
		if (!(value instanceof EffectifDTO)) {
			throw new UnsupportedOperationException(
					"object " + value + " is not a EffectifDTO.");
		}
		EffectifDTO e = (EffectifDTO) value;
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getEffectifFromId(Utils.convertStringToInt(value));
	}
	/**
