 ...
 *
 */
public class IndemnisationConverter implements Serializable, Converter {
	...
	public String getAsString(
		...
		if (!(value instanceof IndemnisationDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getIndemnisationDTOFromId(Utils.convertStringToInt(value));
	}
	/**
