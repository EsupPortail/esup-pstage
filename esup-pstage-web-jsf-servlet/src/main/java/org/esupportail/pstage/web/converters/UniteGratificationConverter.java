 ...
 *
 */
public class UniteGratificationConverter implements Serializable, Converter {
	 ...
	 * Bean constructor.
	 */
	public UniteGratificationConverter() {
		super();
	}
	/**
	...
	public String getAsString(
		...
		if (!(value instanceof UniteGratificationDTO)) {
			throw new UnsupportedOperationException(
					"object " + value + " is not a UniteGratificationDTO.");
		}
		UniteGratificationDTO e = (UniteGratificationDTO) value;
		return ""+e.getId();
	}
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getUniteGratificationDTOFromId(Utils.convertStringToInt(value));
	}
	/**
