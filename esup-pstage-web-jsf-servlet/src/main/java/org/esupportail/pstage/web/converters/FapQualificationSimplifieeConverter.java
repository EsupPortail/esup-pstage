 ...
 *
 */
public class FapQualificationSimplifieeConverter implements Serializable, Converter {
	 ...
	 * Bean constructor.
	 */
	public FapQualificationSimplifieeConverter() {
		super();
	}
	/**
	...
	public String getAsString(
		...
		if (!(value instanceof FapQualificationSimplifieeDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getFapQualificationSimplifieeFromId(Utils.convertStringToInt(value));
	}
	/**
