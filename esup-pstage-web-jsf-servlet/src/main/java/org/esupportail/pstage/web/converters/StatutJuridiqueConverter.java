 ...
 *
 */
public class StatutJuridiqueConverter implements Serializable, Converter {
	 ...
	 * Bean constructor.
	 */
	public StatutJuridiqueConverter() {
		super();
	}
	/**
	...
	public String getAsString(
		...
		if (!(value instanceof StatutJuridiqueDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getStatutJuridiqueFromId(Utils.convertStringToInt(value));
	}
	/**
