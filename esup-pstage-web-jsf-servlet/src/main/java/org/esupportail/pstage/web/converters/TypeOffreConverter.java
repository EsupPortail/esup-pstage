 ...
 *
 */
public class TypeOffreConverter implements Serializable, Converter {
	...
	public String getAsString(
		...
		if (!(value instanceof TypeOffreDTO)) {
	...
	public Object getAsObject(
		...
		return getNomenclatureDomainService().getTypeOffreFromId(Utils.convertStringToInt(value));
	}
	/**
